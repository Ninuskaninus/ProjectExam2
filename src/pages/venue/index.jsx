...
import { VenueLogin, VenueFormContainer, VenueDescription, CarouselContainer, VenueIcons, VenueInformation, VenueTitle, VenueLocation, VenueUser, VenueHead, VenueContent, Gradient, VenueContainer, VenueBackground } from "./index.styles";
  ...
  return (
    <VenueContainer>
      <VenueContent>
        <VenueHead>
          <VenueUser>
            {venue?.owner?.avatar?.url ? <img src={venue.owner.avatar.url} alt="avatar" /> : <Icons.PlaceholderAvatar />}
            <div>
        ...
        <VenueTitle>
          ...
          <VenueInformation>
            ...
            <p><Icons.Location /> {venue.location.address || "Unkown"}, {venue.location.zip || "Unknown"}, { venue.location.city || "Unknown" }</p>
          </VenueInformation>
        </VenueTitle>
        <VenueIcons>
